                        ...
                        <div class="row  align-items-center">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3">
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="reporting-purposes" id="reporting-purposes-hk"
                                        value="HK Profits Tax declaration 申報香港利得稅"> <label class="form-check-label"
                                        for="reporting-purposes-hk"> HK Profits Tax declaration <br> 申報香港利得稅 </label>
                                </div>
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="reporting-purposes" id="reporting-purposes-borrowing"
                                        value="Borrowing loans from banks 向銀行借款"> <label class="form-check-label"
                                        for="reporting-purposes-borrowing"> Borrowing loans from banks<br> 向銀行借款
                                    </label> </div>
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="reporting-purposes" id="reporting-purposes-funding"
                                        value="Funding purposes 基金要求"> <label class="form-check-label"
                                        for="reporting-purposes-funding"> Funding purposes<br> 基金要求 </label> </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><label for="email">Other: Please
                                    specify <br> 其他：請註明 </label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><input id="other-reporting-purposes"
                                    name="other-reporting-purposes" type="text" class="form-control"> </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><label
                                    for="principal-activities">Principal activities 主要業務</label> </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><label
                                    for="incorporation-date">Incorporation date 公司開立日期</label> </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><label
                                    for="performed-audit-before">Has performed audit before? 是否曾進行核數</label></div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3">
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="performed-audit-before" id="performed-audit-before-yes" value="yes">
                                    <label class="form-check-label" for="performed-audit-before-yes"> Yes </label>
                                </div>
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="performed-audit-before" id="performed-audit-before-no" value="no"> <label
                                        class="form-check-label" for="performed-audit-before-no"> No </label> </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><label for="year-ended-date"> If Yes,
                                    please provide the related year ended date <br> 如是，請提供相關年結日</label></div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><input id="year-ended-date"
                                    name="year-ended-date" type="text" class="form-control"> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><label
                                    for="declared-profits-tax-before">Has declared profits tax before? <br>
                                    是否曾申報利得稅</label></div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3">
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="declared-profits-tax-before" id="declared-profits-tax-before-yes"
                                        value="yes"> <label class="form-check-label"
                                        for="declared-profits-tax-before-yes"> Yes </label> </div>
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="declared-profits-tax-before" id="declared-profits-tax-before-no"
                                        value="no"> <label class="form-check-label"
                                        for="declared-profits-tax-before-no"> No </label> </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><label for="year-assessment"> If Yes,
                                    please provide the related year of assessment <br> 如是，請提供相關課稅年度</label></div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><input id="year-assessment"
                                    name="year-assessment" type="text" class="form-control"> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><label
                                    for="has-receive-tax-return">Has received the tax return this year <br>
                                    有否收到今年度利得稅報稅表</label></div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3">
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="has-receive-tax-return" id="has-receive-tax-return-yes" value="yes">
                                    <label class="form-check-label" for="has-receive-tax-return-yes"> Yes </label>
                                </div>
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="has-receive-tax-return" id="has-receive-tax-return-no" value="no"> <label
                                        class="form-check-label" for="has-receive-tax-return-no"> No </label> </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><label for="excel-file">是否有做會計帳目？
                                    如有，請提供審計年度的Profit and Loss, Balance Sheet 如沒有，請提供以下資料</label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <input type="file"
                                    class="form-control" name="excel-file" id="excel-file"> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"><label for="total-turnover-yearly">
                                    Total Turnover (yearly) 全年總營業額 </label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <input type="text"
                                    class="form-control" name="total-turnover-yearly" id="total-turnover-yearly"> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <label for="any-stock">Any stock?
                                    有否存貨?</label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3">
                                <div class="form-check"> <input class="form-check-input" type="radio" name="any-stock"
                                        id="any-stock-yes" value="yes"> <label class="form-check-label"
                                        for="any-stock-yes" name="any-stock"> Yes </label> </div>
                                <div class="form-check"> <input class="form-check-input" type="radio" name="any-stock"
                                        id="any-stock-no" value="no"> <label class="form-check-label" for="any-stock-no"
                                        name="any-stock"> No </label> </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <label for="no-of-bank-used"> No. of
                                    bank used <br> 使用銀行的數量 </label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <input name="no-of-bank-used"
                                    id="no-of-bank-used" type="text" class="form-control"> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <label
                                    for="no-of-bank-transactions-monthly"> No. of bank transactions (monthly) <br>
                                    每月經銀行交易的數量 </label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <input
                                    name="no-of-bank-transactions-monthly" id="no-of-bank-transactions-monthly"
                                    type="text" class="form-control"> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <label
                                    for="no-of-non-bank-transactions-monthly"> No. of non-bank transactions (monthly)
                                    <br> 每月非經銀行交易的數量 </label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <input
                                    name="no-of-non-bank-transactions-monthly" id="no-of-non-bank-transactions-monthly"
                                    type="text" class="form-control"> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <label for="any-property"> Any
                                    property? <br> 有否物業? </label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3">
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="any-property" id="any-property-yes" value="yes"> <label
                                        class="form-check-label" for="any-property-yes" name="any-property"> Yes
                                    </label> </div>
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="any-property" id="any-property-no" value="no"> <label
                                        class="form-check-label" for="any-property-no" name="any-property"> No </label>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <label for="any-motor-vehicle"> Any
                                    motor vehicle? <br> 有否車輛? </label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3">
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="any-motor-vehicle" id="any-motor-vehicle-yes" value="yes"> <label
                                        class="form-check-label" for="any-motor-vehicle-yes" name="any-motor-vehicle">
                                        Yes </label> </div>
                                <div class="form-check"> <input class="form-check-input" type="radio"
                                        name="any-motor-vehicle" id="any-motor-vehicle-no" value="no"> <label
                                        class="form-check-label" for="any-motor-vehicle-no" name="any-motor-vehicle"> No
                                    </label> </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <label
                                    for="no-of-loans-hire-purchases"> No. of loans / hire purchases <br> 貸款/分期付款數目
                                </label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <input
                                    name="no-of-loans-hire-purchases" id="no-of-loans-hire-purchases" type="text"
                                    class="form-control"> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <label for="no-of-employees"> No. of
                                    employees <br> 員工人數 </label> </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12  mb-3"> <input name="no-of-employees"
                                    id="no-of-employees" type="text" class="form-control"> </div>
