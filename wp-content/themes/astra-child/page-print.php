        ...
        <div class="print-form-container">
            ...
            <table class="form-table">
                ...
                <tr>
                    <td>
                        服務條款 MAIN TERMS <br>
                        *適用於虛擬辦工室客戶Applicable for Virtual Office Service<br><br>

                        1 本申請表由算數秘書有限公司（“本公司”）提供，並由公司秘書/虛擬辦公室服務計畫申請人（“客戶”）同意，雙方共同履行申請表內所載的條款及細則。
                        This application form is offered by CountAudit Secretarial Limited and accepted by the Company
                        ...
                        3 客戶如自行更改過公司資料，包括及不限於公司名稱、股權變動等，必須於周年日前   7   <br><br>
                        ...
                        *在服務生效前及或終止期間，或任何未經許可的情況下，本公司有權拒絕收取客戶的郵件、包裹、電郵或傳真，及拒絕處理客戶專線電話的來電或傳真，並且不會通知以上各種項目的傳送。在服務終止的30天后，客戶遺下的任何郵件、包裹、傳真和物件，本公司有權代為處理。
                        ...
                        service charges during the affected period. 
